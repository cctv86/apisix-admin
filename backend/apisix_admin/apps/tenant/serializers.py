...
class TenantSerializer(serializers.ModelSerializer):
    url = serializers.CharField(required=True, max_length=300, label="url地址")
    location = serializers.CharField(required=True, max_length=300, label="位置")
    ...
    desc = serializers.CharField(max_length=500, label="描述")
